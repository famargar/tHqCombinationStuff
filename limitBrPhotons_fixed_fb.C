...
int main() {
    ...
    vector<double> const   limit2SDown{1.99*231,  1.68*231,  1.40*231,  1.37*231,  1.30*231,  1.25*231,  1.2*231};
    vector<double> const   limit1SDown{2.36*231,  1.97*231,  1.82*231,  1.77*231,  1.6*231,  1.5*231,  1.55*231};
    vector<double> const     limitMean{3.00*231,  2.75*231,  2.5*231,  2.3*231,  2.15*231,  2.07*231,  1.91*231};
    vector<double> const     limit1SUp{4.43*231,  3.98*231,  3.44*231,  3.10*231,  2.9*231,  2.85*231,  2.84*231};
    vector<double> const     limit2SUp{5.90*231,  5.48*231,  5.01*231,  4.5*231,  4.15*231,  4.0*231,  3.9*231};
